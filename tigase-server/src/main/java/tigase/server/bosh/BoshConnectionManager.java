...
import static tigase.server.bosh.Constants.BATCH_QUEUE_TIMEOUT_KEY;
import static tigase.server.bosh.Constants.BATCH_QUEUE_TIMEOUT_VAL;
import static tigase.server.bosh.Constants.BOSH_SESSION_CLOSE_DELAY_DEF_VAL;
import static tigase.server.bosh.Constants.CONCURRENT_REQUESTS_PROP_KEY;
import static tigase.server.bosh.Constants.CONCURRENT_REQUESTS_PROP_VAL;
import static tigase.server.bosh.Constants.FROM_ATTR;
import static tigase.server.bosh.Constants.HOLD_REQUESTS_PROP_KEY;
import static tigase.server.bosh.Constants.HOLD_REQUESTS_PROP_VAL;
import static tigase.server.bosh.Constants.MAX_BATCH_SIZE_KEY;
import static tigase.server.bosh.Constants.MAX_BATCH_SIZE_VAL;
import static tigase.server.bosh.Constants.MAX_INACTIVITY_PROP_KEY;
import static tigase.server.bosh.Constants.MAX_INACTIVITY_PROP_VAL;
import static tigase.server.bosh.Constants.MAX_PAUSE_PROP_KEY;
import static tigase.server.bosh.Constants.MAX_PAUSE_PROP_VAL;
import static tigase.server.bosh.Constants.MAX_SESSION_WAITING_PACKETS_KEY;
import static tigase.server.bosh.Constants.MAX_SESSION_WAITING_PACKETS_VAL;
import static tigase.server.bosh.Constants.MAX_WAIT_DEF_PROP_KEY;
import static tigase.server.bosh.Constants.MAX_WAIT_DEF_PROP_VAL;
import static tigase.server.bosh.Constants.MIN_POLLING_PROP_KEY;
import static tigase.server.bosh.Constants.MIN_POLLING_PROP_VAL;
import static tigase.server.bosh.Constants.PRE_BIND_ATTR;
import static tigase.server.bosh.Constants.RID_ATTR;
import static tigase.server.bosh.Constants.SEND_NODE_HOSTNAME_KEY;
import static tigase.server.bosh.Constants.SEND_NODE_HOSTNAME_VAL;
import static tigase.server.bosh.Constants.SESSION_ID_ATTR;
import static tigase.server.bosh.Constants.SID_ATTR;
import static tigase.server.bosh.Constants.SID_LOGGER_KEY;
import static tigase.server.bosh.Constants.SID_LOGGER_VAL;
import static tigase.server.bosh.Constants.TO_ATTR;
import static tigase.server.bosh.Constants.USER_ID_ATTR;
